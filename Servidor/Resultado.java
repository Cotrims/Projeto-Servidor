/**
 * A classe Resultado � uma heran�a de Comunicado que serve para passar o
 * atributo vencedor entre o servidor e os clientes, atrav�s do inst�ncia de
 * Resultado. Essa classe possui o construtor e um getter.
 * 
...
public class Resultado extends Comunicado {
	...
	/**
	 * Constroi uma nova inst�ncia da classe Resultado. Para tanto, deve ser
	 * fornecido uma String que ser� atribuido � variavel vencedor.
	 * 
	...
	/**
	 * Retorna atributo vencedor Retorna o atributo vencedor da inst�ncia a qual
	 * este m�todo for aplicado.
	 * 
	 ...
	 * vencedor representado pela inst�ncia a qual o m�todo for aplicado.
	 * 
