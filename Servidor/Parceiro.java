...
public class Parceiro {
	...
	public Parceiro(Socket conexao, ObjectInputStream receptor, ObjectOutputStream transmissor, String nome,
			char escolha, boolean escolher, int numeroOponente, int numero) throws Exception // se parametro nulos
	{
		if (conexao == null)
			throw new Exception("Conexao ausente");
	...
	/**
	 * Clona Parceiro Produz e retorna uma c�pia da inst�ncia this de Parceiro.
	 * 
	...
	/**
	 * Gera um String com toda a informa��o presente na classe Parceiro. � feito um
	 * String que recebe todos os valores de atributos da classe.
	 * 
	...
	/**
	 * Calula e retorna o hashcode da inst�ncia do tipo Parceiro. Calcula o hashcode
	 * da classe Parceiro representada pela inst�ncia � qual o m�todo for aplicado.
	 * 
	...
	/**
	 * Verifica se duas inst�ncias de Parceiro s�o iguais. Verifica se o Object
	 * fornecido como par�metro � a mesma Parceiro da inst�ncia, resultando true em
	 * caso afirmativo, ou false, caso n�o forem iguais.
	 * 
	...
	public boolean equals(Object obj) {
		...
		if (this.escolha != par.escolha || this.escolher != par.escolher || this.numeroOponente != par.numeroOponente
				|| this.nome != par.nome || this.numero != par.numero)
			return false;

		if (!this.conexao.equals(par.conexao) || !this.receptor.equals(par.receptor)
				|| !this.transmissor.equals(par.transmissor))
			return false;
	...
	/**
	 * Constroi uma c�pia da inst�ncia da classe Parceiro. Deve ser passado no
	 * parametro uma inst�ncia de Parceiro para ser usada como modelo para criar uma
	 * nova.
	 * 
